                            ...
                            <div class="col-xl-4">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li class="text-muted"><i class="fas fa-circle"></i> <span
                                        ...
                                        <?php if ($status === 'ชำระเงินแล้ว') { ?>
                                            <span class="badge bg-warning text-black fw-bold">
                                                <?= $status ?>
                                            <?php } ?>

                                            <?php if ($status === 'กำลังเตรียมพิซซ่า') { ?>
                                                <span class="badge bg-info text-black fw-bold">
                                                    <?= $status ?>
                                                <?php } ?>
                                            </span>

                                            <?php if ($status === 'กำลังจัดส่งกรุณารอรับ') { ?>
                                                <span class="badge bg-primary-emphasis text-black fw-bold">
                                                    <?= $status ?>
                                                <?php } ?>
                                            </span>

                                            <?php if ($status === 'ออเดอร์เรียบร้อย') { ?>
