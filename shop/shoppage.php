                ...
                <div class="collapse navbar-collapse" id="navbarExample01">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="btn btn-outline-warning" aria-current="page" href="#">Sign in</a>
                                </li>
                            </ul>
                        </div>
                    </ul>
    ...
    <div class="container text-center mt-3">
        <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2">
            ...
            <div class="col-md-6">
                <div class="p-2">
                    <div class="card">
                        <img src="../images/pizza-2.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <p class="card-text">Some quick example text to build on the card title and make
                                up the bulk
                                of the card's content.</p>
            ...
            <div class="col-md-6">
                <div class="p-2">
                    <div class="card">
                        <img src="../images/pizza-3.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <p class="card-text">Some quick example text to build on the card title and make
                                up the bulk
                                of the card's content.</p>
            ...
            <div class="col-md-6">
                <div class="p-2">
                    <div class="card">
                        <img src="../images/pizza-4.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <p class="card-text">Some quick example text to build on the card title and make
                                up the bulk
                                of the card's content.</p>
            ...
            <div class="col-md-6">
                <div class="p-2">
                    <div class="card">
                        <img src="../images/pizza-5.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <p class="card-text">Some quick example text to build on the card title and make
                                up the bulk
                                of the card's content.</p>
            ...
            <div class="col-md-6">
                <div class="p-2">
                    <div class="card">
                        <img src="../images/pizza-6.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <p class="card-text">Some quick example text to build on the card title and make
                                up the bulk
                                of the card's content.</p>
